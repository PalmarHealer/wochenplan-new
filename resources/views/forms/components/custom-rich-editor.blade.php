    ...
    @else
        ...
        >
            ...
            <trix-toolbar
                id="trix-toolbar-{{ $id }}"
                @class([
                    'fi-fo-rich-editor-toolbar relative flex flex-col gap-x-3 bg-white dark:bg-white/5 border-b border-gray-100 px-2.5 py-2 dark:border-white/10',
            ...
            >
                ...
                <div x-cloak data-trix-dialogs class="trix-dialogs">
                    <div
                        ...
                        class="hidden trix-dialog trix-dialog--link"
                    >
